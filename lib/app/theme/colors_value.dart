...
abstract class ColorsValue {
  ...
  static const Color offWhiteColor = Color(
    offWhiteColorHex,
  );
  ...
  /// Hex Values
  ///
  static int primaryColorHex = 0xFFEA6F00;
  static int secondaryColorHex = 0xffB000F0;
  static int scaffoldBackgroundColorHex =
      globalVariable == 1 ? 0xff000000 : 0xffffffff;
  static const int blackColorHex = 0xff000000;
  static const int greyColorHex = 0xFF919EB6;
  ...
  static const int offWhiteColorHex = 0xffF7F8FA;
  static const int greenColorHex = 0xff01B99F;
  ...
  static const int lightBlackColorHex = 0xff313B49;
